  ...
  <x-subheader-dinamyc title="Kecamatan">
    ...
    <div class="default-btns" style="display: none;">
      <x-btn.a-weight-bold-svg svg="Navigation/Angle-left.svg" href="{{ route('kabupaten.index') }}"
        ...
        Kabupaten</x-btn.a-weight-bold-svg>

      <x-btn.a-weight-bold-svg svg="Design/Flatten.svg" href="{{ route('kecamatan.create', ['kab' => $id]) }}"
        class="btn-sm btn-light-success mr-2">
...
@section('content')
  <!--begin::Card-->
  <input type="hidden" id="urx" value="{{ URL('kecamatan/' . $id) }}">
  <div class="viewdata">
