...
@section('content')
  ...
  <form action="{{ route('tps.update', ['tp' => $data->id]) }}" class="row" method="POST">
    @method('PUT')
    @csrf
    <div class="col-md-12">
      <div class="card card-custom card-stretch gutter-b">
        <div class="card-header">
          <h3 class="card-title">Ubah TPS</h3>
        </div>
        <div class="card-body">
          <div class="row">
            ...
            <div class="col-md-6">
              <x-validation.txt-stack type="text" name="name" placeholder="Nama TPS"
