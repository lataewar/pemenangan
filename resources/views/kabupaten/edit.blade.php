...
@section('content')
  <!--begin::Card-->
  <form action="{{ route('kabupaten.update', ['kabupaten' => $data->id]) }}" class="row" method="POST">
    @method('PUT')
    @csrf
    <div class="col-md-12">
      <div class="card card-custom card-stretch gutter-b">
        <div class="card-header">
          <h3 class="card-title">Ubah Kabupaten</h3>
        </div>
        <div class="card-body">
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <x-validation.txt-stack type="text" name="name" placeholder="Nama Daerah"
              ...
              <x-validation.txt-stack type="text" name="jumlah_dpt" placeholder="Jumlah DPT"
                oninput="formatRupiah(this, '.')" value="{{ old('jumlah_dpt') ?? formatNomor($data->jumlah_dpt) }}"
                :messages="$errors->get('jumlah_dpt')">Jumlah
