<form action="{{ route('user.store') }}" class="row createform" id="createform" method="POST">
  @csrf
  <div class="col-md-12">
    <div class="card card-custom card-stretch gutter-b">
      ...
      <div class="card-body">
        <div class="row">
          ...
          <div class="col-md-6">
            <x-form.txt-stack name="name" id="name" placeholder="Nama">Nama <x-redstar /></x-form.txt-stack>
            <x-form.input-stack type="email" name="email" id="email" placeholder="Email">Email <x-redstar /></x-form.input-stack>
