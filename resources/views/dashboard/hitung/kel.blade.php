  ...
  <div class="subheader py-2 py-lg-6 subheader-solid" id="kt_subheader">
    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
      ...
      <div class="d-flex align-items-center flex-wrap mr-1">
        ...
        <div class="d-flex align-items-baseline flex-wrap mr-5">
          ...
          <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
            ...
            <li class="breadcrumb-item text-muted">
              <a href="{{ route('dashboard.hitung.kec', ['kab' => $kecamatan->kabupaten_id]) }}"
                class="text-muted">Kecamatan</a>
            </li>
            <li class="breadcrumb-item text-muted">
              <a href="#" class="text-muted">Desa/Kelurahan</a>
            </li>
          </ul>
          <!--end::Breadcrumb-->
        </div>
      ...
      <div class="d-flex align-items-center">
        <x-btn.a-weight-bold-svg svg="Navigation/Angle-left.svg"
          href="{{ route('dashboard.hitung.kec', ['kab' => $kecamatan->kabupaten_id]) }}"
  ...
  <div class="card card-custom">
    <div class="card-header card-header-tabs-line">
      <div class="card-title">
        <h3 class="card-label">Perhitungan Suara - Kecamatan {{ $kecamatan->name }}</h3>
      </div>
          ...
          <table class="table table-hover table-bordered">
            <thead>
              <tr>
                ...
                <th class="text-center" width="60%">Alokasi Suara</th>
              </tr>
            </thead>
            <tbody>
