    ...
    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
      ...
      <div class="d-flex align-items-center flex-wrap mr-1">
        ...
        <div class="d-flex align-items-baseline flex-wrap mr-5">
          ...
          <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
            ...
            <li class="breadcrumb-item text-muted">
              <a href="{{ route('dashboard.target.kec', ['kab' => $kecamatan->kabupaten_id]) }}"
      ...
      <div class="d-flex align-items-center">
        <x-btn.a-weight-bold-svg svg="Navigation/Angle-left.svg"
          href="{{ route('dashboard.target.kec', ['kab' => $kecamatan->kabupaten_id]) }}"
  ...
  <div class="card card-custom">
    <div class="card-header card-header-tabs-line">
      <div class="card-title">
        <h3 class="card-label">Target - Kecamatan {{ $kecamatan->name }}</h3>
      </div>
