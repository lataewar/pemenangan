  ...
  <div class="login login-1 login-signin-on d-flex flex-column flex-lg-row flex-column-fluid bg-white" id="kt_login">
    ...
    <div class="login-aside d-flex flex-row-auto bgi-size-cover bgi-no-repeat p-10 p-lg-10"
      ...
      <div class="d-flex flex-row-fluid flex-column justify-content-between">
        ...
        <a href="#" class="flex-column-auto mt-5 pb-lg-0 pb-10">
          <img src="{{ asset('assets') }}/media/logos/logo-letter-9.png" class="max-h-70px" alt="" />
        </a>
        <!--end: Aside header-->
        <!--begin: Aside content-->
        <div class="flex-column-fluid d-flex flex-column justify-content-center">
          <h3 class="font-size-h1 mb-5 text-white">Selamat datang di Aplikasi Lorem ipsum dolor sit amet.
          </h3>
          <h3 class="font-weight-lighter text-white opacity-80">SI LOREM IPSUM</h3>
        </div>
        <!--end: Aside content-->
        <!--begin: Aside footer for desktop-->
        <div class="d-none flex-column-auto d-lg-flex justify-content-between mt-10">
          <div class="opacity-70 font-weight-bold text-white">© 2023 Lataewar</div>
          <div class="d-flex">
    ...
    <div class="d-flex flex-column flex-row-fluid position-relative p-7 overflow-hidden">
      ...
      <div
        ...
        <div class="text-dark-50 font-weight-bold order-2 order-sm-1 my-2">© 2023 Lataewar</div>
